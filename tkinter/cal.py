...
def equals():
    ...
    try:
        ...
        equation_label.set("syntax error, try again ")
...
label = Label(window, textvariable=equation_label, font=('Courier New', 20), bg="white", width=24, height=2).pack()

frame = Frame(window)
frame.pack()

button1 = Button(frame, text=1, height=4, width=9, font=35, background="red", command=lambda: button_press(1))
...
decimal = Button(window, text="Clear", height=4, width=12, font=35, command=lambda: button_press('.'))
decimal.pack()
